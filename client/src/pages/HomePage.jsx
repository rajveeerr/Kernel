...
const HomePage = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center text-white h-screen bg-gray-900">
      <div className="text-center">
        <h1 className="text-5xl font-bold mb-2">
          kernel<span className="text-purple-400">[dot]</span>chat
        </h1>
      ...
      <div className="w-full max-w-sm">
        <form onSubmit={joinChat} className="flex flex-col items-center">
          ...
          <input
            ...
            className="w-full px-4 py-3 mb-6 text-center bg-gray-800 border border-gray-700 rounded-full focus:outline-none focus:ring-2 focus:ring-purple-500"
          />
          <p className="text-gray-500 mb-6">or</p>
        </form>
        <button
          onClick={startNewChat}
          className="w-full px-4 py-3 bg-white text-gray-900 font-bold rounded-full hover:bg-gray-200 transition-colors duration-200 flex items-center justify-center"
        >
      ...
      <p className="absolute bottom-5 text-xs text-gray-600">
